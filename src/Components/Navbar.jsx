            ...
            <div className='container mx-auto px-4 md:px-16 lg:px-24 py-4 flex  justify-between item-center items-center'>
                ...
                <div className='relative flex-1 mx-4'>
                    <form onSubmit={handleSearch}>
                        <input type="text" placeholder='Enter Product Here...' className='text-xs md:text-xs lg:text-sm  w-full border border-gray-300/50 py-2 px-4' onChange={(e)=>setSearch(e.target.value)} />
